...
When an incident does occur, it is important to report it promptly. To report a possible violation, contact any Community Moderator (either a committer who is a maintainer of the repository or a NeoNephos foundation member) in private.
...
representing the community in public or other spaces. 
Examples of representing our community include using an 
official email address, posting via an official social 
